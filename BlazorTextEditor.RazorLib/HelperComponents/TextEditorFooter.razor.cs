...
public partial class TextEditorFooter : ComponentBase
{
    ...
    public async Task ReRenderTextEditorFooterAsync(
        TextEditorFooterParameters textEditorFooterParameters)
    {
        _textEditorBase = textEditorFooterParameters.TextEditorBase;
        _textEditorDisplay = textEditorFooterParameters.TextEditorDisplay;
